...
bool Config::load(const std::string& path) {
    ...
    if (to_lower(mute_mode) == "duck") mute_mode = "volume_drop";  // pre-0.18 name
    I("drop_steps", drop_steps);
    I("duck_steps", drop_steps);   // pre-0.18 key for the same setting
