...
int main(int argc, char** argv) {
    ...
    // A web/WebSocket peer that disconnects mid-write must not kill the
    // process (macOS and Linux both deliver SIGPIPE on send-to-closed-socket;
    // we handle the resulting EPIPE return codes instead).
