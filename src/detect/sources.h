...
public:
    ...
    // Compensation added to measured levels (dB). Used in volume-drop mode
    // with a room mic: the app measures how much the drop attenuated the room
    // and sets it here, so dropped audio is judged on the original scale.
