...
public:
    ...
    // target (web remote SET VOLUME TARGET button). Persisted to the config.
...
private:
    ...
    bool suppressing_ = false;            // we have the TV muted/ducked
